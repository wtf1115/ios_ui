...
class TodolistBuild(BasePage):
    ...
    def click_welfare_home_search(self):
        ...
        #  点击搜索
        self.waiter.until(lambda x: self.driver.find_element_by_xpath("(//XCUIElementTypeStaticText)[2]/..")).click()
        # self.waiter.until(lambda x: self.driver.find_element_by_xpath('//XCUIElementTypeApplication[@name="更美TEST"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]')).click()
