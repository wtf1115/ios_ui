...
class Search_result_welfare_pv(unittest.TestCase):
    log = Log()

    def test_search_result_welfare_pv(self):
        """
        搜索结果页-美购
        """
        ...
        with GMdriver() as driver:
            ...
            time.sleep(5)
            driver.click_welfare_statictext()
            time.sleep(1)
            driver.background_app(3)

        result = mysql_test.query(action='page_view', page_name='search_result_welfare', event_time=begin_date)
